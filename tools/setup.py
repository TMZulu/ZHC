...
if __name__ == "__main__":
    ...
    if exitcode > 0:
        print("\nSomething went wrong during the setup. Make sure you run this script as administrator. If these issues persist, please follow the instructions on the ACRE2 wiki to perform the setup manually.")
    else:
